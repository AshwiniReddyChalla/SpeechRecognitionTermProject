...
def get_tokenized_data(data_dir, in_vocab_size):
    ...
    return [(in_seq_train_ids_path, label_train_ids_path),
            (in_seq_dev_ids_path, label_dev_ids_path),
            (in_seq_test_ids_path, label_test_ids_path),
            (in_vocab_path, label_path)]